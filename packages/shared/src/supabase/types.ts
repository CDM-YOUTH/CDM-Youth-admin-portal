// Hand-maintained copy of the admin app's generated Supabase types, extended
// with the Youth Portal migrations (youths.auth_user_id, notifications,
// otp_codes, youth_category 'Other'). If you regenerate types from the admin
// app's Supabase project, re-apply those additions here.
export type Json =
  | string
  | number
  | boolean
